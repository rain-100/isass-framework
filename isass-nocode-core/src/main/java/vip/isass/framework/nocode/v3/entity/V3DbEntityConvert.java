 ...
 */
@Slf4j
public class V3DbEntityConvert {
    ...
    public void setPackageName(String packageName) {
        V3DbEntityConvert.packageName = packageName;
    }

    @SneakyThrows
    @SuppressWarnings("unchecked")
    public static <E extends IV3Entity<E>, EDB extends IV3DbEntity<E, EDB>> EDB convertToDbEntity(E entity) {
        if (entity == null || entity instanceof IV3DbEntity) {
            return (EDB) entity;
        }
    ...
    @SuppressWarnings("unchecked")
    public static <E extends IV3Entity<E>, EDB extends IV3DbEntity<E, EDB>> E convertToEntity(EDB entity) {
        return (E) entity;
    }

    @SuppressWarnings("unchecked")
    public static <E extends IV3Entity<E>, EDB extends IV3DbEntity<E, EDB>> List<EDB> convertToEdbEntities(Collection<E> entities) {
        List<EDB> edbEntities = new ArrayList<>(entities.size());
        for (E entity : entities) {
            if (entity instanceof IV3DbEntity) {
    ...
    public static <E extends IV3Entity<E>, EDB extends IV3DbEntity<E, EDB>> List<E> convertToEntities(Collection<EDB> entities) {
        return entities == null
                ? null
                : entities.stream()
                .map(V3DbEntityConvert::convertToEntity)
    ...
    static Class<?> findDbEntityClasses(String scanPackageName, Class<?> entityClass) {
        ...
        return classes.stream()
                .filter(IV3DbEntity.class::isAssignableFrom)
                .findFirst()
