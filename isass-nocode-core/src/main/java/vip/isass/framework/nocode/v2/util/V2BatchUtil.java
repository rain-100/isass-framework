package vip.isass.framework.nocode.v2.util;
...
/**
 * 批量操作工具（v2）。
 * 基于 nocode.v2 分页条件，提供分页全量查询和分批处理。
 */
@Slf4j
public final class V2BatchUtil {

    private V2BatchUtil() {
    }

    public static <R, E extends IV2Entity<E>, C extends IV2PageCriteria<E, C>> List<R> findAllByBatchPage(
            C countCriteria,
    ...
    public static <E extends IV2Entity<E>, C extends IV2PageCriteria<E, C>> void batchFunction(
            C countCriteria,
            Function<C, Integer> countFunction,
            C fetchCriteria,
            Function<C, IPage<E>> fetchFunction,
