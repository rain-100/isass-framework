package vip.isass.framework.nocode.v3.util;
...
/**
 * 批量操作工具（v3）。
 * 基于 nocode.v3 分页条件，提供分页全量查询和分批处理。
 */
@Slf4j
public final class V3BatchUtil {

    private V3BatchUtil() {
    }

    public static <R, E extends IV3Entity<E>, C extends IV3PageCriteria<E, C>> List<R> findAllByBatchPage(
            C countCriteria,
    ...
    public static <E extends IV3Entity<E>, C extends IV3PageCriteria<E, C>> void batchFunction(
            C countCriteria,
            Function<C, Integer> countFunction,
            C fetchCriteria,
            Function<C, IPage<E>> fetchFunction,
