 ...
 */
final class V3GrpcChunkOutputStream extends OutputStream {
    ...
    V3GrpcChunkOutputStream(StreamObserver<byte[]> observer) {
    ...
    private void flushBuffer() {
        ...
        observer.onNext(V3GrpcFileFrames.content(buffer, 0, count));
        count = 0;
    }
}
