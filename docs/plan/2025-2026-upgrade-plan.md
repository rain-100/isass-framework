...
基于isass-framework v3.x版本（JDK8 + Spring Boot 2）进行全面升级重构并升级为v4.0，升级到JDK21 + Spring Boot 3，并解决现有架构问题。
...
### 2.2 重构方案
- [ ] 框架内部所有子模块全部移除@Resource等Spring注解 【工作量：1人日】
- [ ] 框架内部各模块通过接口+SPI发现机制进行解耦和自动装配，不依赖任何IOC框架 【工作量：20人日】
- [ ] 新建isass-framework-spring-starter模块与Spring集成 【工作量：5人日】
...
### 3.2 重构方案
- [x] 替换为Liquibase作为数据库管理工具 【工作量：5人日】
...
## 工作量与时间安排
- **2025年下半年**：基础环境升级(12) + IOC依赖注入重构(26) + 数据库管理重构(23) + 异常处理重构(7) = **68人日**
- **2026年上半年**：零代码模块重构(105) + 接口文档重构(10) = **115人日**  
