 ...
 */
public final class InternalServiceEndpointMatcher {
    ...
    public InternalServiceEndpointMatcher(Environment environment, ListableBeanFactory beanFactory) {
    ...
    private Collection<URI> explicitEndpoints() {
        ...
        Stream<URI> serviceEndpoints = StreamSupport.stream(configurableEnvironment.getPropertySources().spliterator(), false)
    ...
    private boolean matches(URI endpoint, URI request) {
        ...
        return "/".equals(endpointPath)
                || requestPath.equals(endpointPath)
